...
final class PulseUITests: BaseUITestCase {
    ...
    func testMainAppNavigationFlow() {
        ...
        XCTAssertTrue(bookmarksTab.safeWaitForExistence(timeout: 5), "Bookmarks tab should exist")
        ...
        XCTAssertTrue(feedTab.safeWaitForExistence(timeout: 5), "Feed tab should exist")
        ...
        XCTAssertTrue(searchTab.safeWaitForExistence(timeout: 5), "Search tab should exist")
        ...
        let navBarReady = homeNavBar.safeWaitForExistence(timeout: Self.launchTimeout)
