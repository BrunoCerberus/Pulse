...
/// Router for For You module navigation.
///
/// @MainActor ensures all navigation operations happen on the main thread.
@MainActor
final class ForYouNavigationRouter: NavigationRouter, Equatable {
    ...
    func route(navigationEvent: ForYouNavigationEvent) {
...
extension ForYouNavigationRouter {
    /// Compare routers by their underlying coordinator reference
    nonisolated static func == (lhs: ForYouNavigationRouter, rhs: ForYouNavigationRouter) -> Bool {
